...
class BuyersOrSellersRowData_ACC implements Serializable {
  ...
  property get liableEarningsAmountsForYear() : LiableEarningsAmountsData_ACC[] {
  ...
  property set liableEarningsAmountsForYear(le : LiableEarningsAmountsData_ACC[]) {
    _liableEarningsAmountsForYear = le
  }

  function resetHeaderLabels() {
    var headers = new ArrayList<HeaderLabels>()
        ...
        for (years in buyer.LiableEarningsAmountsForYearArray) {
          if (years.Year == year) {
            ...
            if (liableEarningsTotalForYear == 0 or years.LiableEarningsAmount == 0) {
              ...
              var percentage = (years.LiableEarningsAmount / liableEarningsTotalForYear)
