...
uses gw.webservice.pc.pc1000.ccintegration.lob.CCEMPPolicyLineMapper
...
uses gw.webservice.pc.pc1000.ccintegration.lob.CCINDPolicyLineMapper
  ...
  private function getLineSpecificMapper(line : PolicyLine) : gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper {
    ...
    switch (line.PatternCode) {
      ...
      case "ManualLine":  //APD specific change to handle Manual lines
        ...
        break;
      case "INDCPXLine":
        mapper = new gw.webservice.pc.pc1000.ccintegration.lob.CCCPXPolicyLineMapper(line, this);
        break;
      case "INDCoPLine":
        mapper = new CCINDPolicyLineMapper(line, this);
        break;
      case "EMPWPCLine":
        mapper = new CCEMPPolicyLineMapper(line, this);
        break;
      case "CWPSLine":
        mapper = new gw.webservice.pc.pc1000.ccintegration.lob.CCSHCPolicyLineMapper(line, this);
        break;case "AEPLine":
        mapper = new gw.webservice.pc.pc1000.ccintegration.lob.CCAEPPolicyLineMapper(line, this);
