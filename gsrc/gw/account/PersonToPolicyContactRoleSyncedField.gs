...
class PersonToPolicyContactRoleSyncedField<S extends PolicyContactRole, T> extends ContactToPolicyContactRoleSyncedField<S, T> {
  ...
  public static final var Prefix          : PersonToPolicyContactRoleSyncedField<PolicyContactRole, String> = new PersonToPolicyContactRoleSyncedField<PolicyContactRole, String>("Prefix")
