...
class DuplicateContactResultImpl extends AbstractContactResultExternal implements DuplicateContactResult {
  ...
  //TODO: Remove this dummy data when story "US176-Contacts Search" is complete
  private var _accreditationNumber_ACC : String as readonly AccreditationNumber_ACC
  private var _accreditationType_ACC : String as readonly AccreditationType_ACC
  ...
  construct(rawResult : ABContactAPIFindDuplicatesResult) {
    ...
    _accreditationNumber_ACC = "123456"
    _accreditationType_ACC = "Sample Type"
  }
