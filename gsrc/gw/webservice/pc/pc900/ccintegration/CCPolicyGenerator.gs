...
uses gw.webservice.pc.pc900.ccintegration.lob.CCEMPPolicyLineMapper
uses gw.webservice.pc.pc900.ccintegration.lob.CCINDPolicyLineMapper
...
class CCPolicyGenerator {
  ...
  private function getLineSpecificMapper(line : PolicyLine) : CCBasePolicyLineMapper {
    ...
    switch (line.PatternCode) {
      ...
      case "INDCPXLine":
        mapper = new gw.webservice.pc.pc900.ccintegration.lob.CCCPXPolicyLineMapper(line, this);
        break;
      case "INDCoPLine":
      ...
      case "EMPWPCLine":
        ...
        break;
      case "CWPSLine":
        mapper = new gw.webservice.pc.pc900.ccintegration.lob.CCSHCPolicyLineMapper(line, this);
        break;case "AEPLine":
        mapper = new gw.webservice.pc.pc900.ccintegration.lob.CCAEPPolicyLineMapper(line, this);
