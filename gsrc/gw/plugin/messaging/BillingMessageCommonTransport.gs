...
uses nz.co.acc.messaging.MessagingUtil_ACC
uses nz.co.acc.plm.integration.files.outbound.wsc.outboundfilesapi.outboundfilesapi.OutboundFilesAPI
uses entity.Contact

@Export
class BillingMessageCommonTransport implements MessageTransport {
  ...
  // == ACC List ===========================
  public static final var ACCOUNTINFOCHANGED_ACC_MSG : String = "OutboundAccountInfoChanged_ACC"
    ...
    try {
      switch(message.EventName){
        ...
        case CREATEPERIOD_MSG:
          ...
          createAltBillingAccountIfNecessary(policyPeriod.AltBillingAccountNumber_ACC, getTransactionId(message) + "-1")
        ...
        case UPDATECONTACT_MSG:
          ...
          break
        //==================== Beginning of Added by ACC ===============================
        case ACCOUNTINFOCHANGED_ACC_MSG:
          var account = message.MessageRoot as Account
          var outboundFilesAPI = new OutboundFilesAPI()
          outboundFilesAPI.accountInfoChanged(account.AccountNumber)
          break
        //==================== End of Added by ACC =====================================
        default:
  ...
  override function resume() {
    logger.info(BillingMessageCommonTransport.Type.RelativeName + " resumed")
  }

  override function shutdown() {
    logger.info(BillingMessageCommonTransport.Type.RelativeName + " shutdown")
  }

  override function suspend() {
    logger.info(BillingMessageCommonTransport.Type.RelativeName + " suspended")
  }
