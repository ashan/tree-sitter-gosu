...
class AddressCountrySettings {
  private static final var validPCFModes : Set<String> = { "default", "BigToSmall", "PostCodeBeforeCity", "", null }.toSet().freeze()
  ...
  private static final var DEFAULT_FIELDS : Set<AddressOwnerFieldId> = new HashSet<AddressOwnerFieldId>() {
      field.ATTENTION_ACC, field.COUNTRY, field.ADDRESS_FINDER_ACC, field.ADDRESSLINE1, field.ADDRESSLINE2, field.ADDRESSLINE3, field.CITY, field.POSTALCODE, field.VALIDUNTIL}.freeze()
