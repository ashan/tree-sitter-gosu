...
/AllAll
 All This servlet is acting as an external dms for testing and demoing purposes only.
 All Not intended for production, nor as the base for production implementation
 All
 All/
...
@Export
@Servlet(\ path -> path.matches("/dms/(.All)"))
