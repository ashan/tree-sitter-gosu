...
internal class ContactMapper extends ContactMapperPCBase {
  ...
  override property get Mappings() : Set<PropertyMapping> {
    ...
    return {
      ...
      fieldMapping(Contact#EmailVerifiedDate_ACC),
      fieldMapping(Contact#CorrespondencePreference_ACC),
      fieldMapping(Contact#IRCellPhone_ACC),
      fieldMapping(Contact#IRPhoneVerifiedStatus_ACC),
      fieldMapping(Contact#ACCID_ACC),
      // PC uses special code in PCTaxIDFieldMapping for handling TaxID.
      new PCTaxIDFieldMapping(),

      // DE149 Geoff Infield 2017-04-20 add new company cellphone fields
      fieldMapping(Company#CellPhone_ACC),
      fieldMapping(Company#CellPhoneCountry_ACC),
      fieldMapping(Company#CellPhoneExtension_ACC),
      ...
      fieldMapping(Address#PublicID)
          .withMappingDirection(TO_XML)
          .withABName(EXTERNAL_PUBLIC_ID),
      fieldMapping(Address#Attention_ACC),
      ...
      fieldMapping(Address#AddressLocType_ACC),
      fieldMapping(Address#AddressPolicyType_ACC),
      ...
      fieldMapping(Address#IsCPCPXAddress_ACC),
      fieldMapping(Address#IsWPCAddress_ACC),
      fieldMapping(Address#IsWPSAddress_ACC),
