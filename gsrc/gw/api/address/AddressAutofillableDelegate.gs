...
class AddressAutofillableDelegate implements AddressFillableExtension {
  ...
  property set Attention_ACC(value : String) { (_af as Address).setAttention_ACC(value) }
  property get Attention_ACC() : String { return (_af as Address).getAttention_ACC() }

  property set ValidUntil_ACC(value : Date) { (_af as Address).setValidUntil(value) }
  property get ValidUntil_ACC() : Date { return (_af as Address).getValidUntil() }
