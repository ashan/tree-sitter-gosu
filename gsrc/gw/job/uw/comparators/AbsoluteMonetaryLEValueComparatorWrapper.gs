 ...
 */
@Export
final class AbsoluteMonetaryLEValueComparatorWrapper extends MonetaryAmountValueComparatorWrapper {
  ...
  override function compare(value : String, referenceValue : String) : boolean {
    var v : MonetaryAmount = new MonetaryAmount(value).abs()
    var val = ValueType.deserialize(v.toString())
