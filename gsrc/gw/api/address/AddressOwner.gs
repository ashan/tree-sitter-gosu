...
interface AddressOwner {
  ...
  /**
   * Label to show for the Attention
   */
  ...
  /**
   * Returns ValidUntil configuration data
   */
  property get ValidUntil_ACC() : Date

  /**
   * Label to show for the ValidUntil
   */
  ...
  property get Migrated_ACC() : boolean {return false}
  property set Migrated_ACC(value : boolean) {/* no default Implementation */}
