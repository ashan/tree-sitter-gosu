...
class JavaxEmailMessageTransport implements MessageTransport, InitializablePlugin {
  ...
  private var logger = StructuredLogger.MESSAGING.withClass(JavaxEmailMessageTransport)
  ...
  override function shutdown() : void {
    logger.info(JavaxEmailMessageTransport.Type.RelativeName + " shutdown")
  }

  override function suspend() : void {
    logger.info(JavaxEmailMessageTransport.Type.RelativeName + " suspended")
  }

  override function resume() : void {
    logger.info(JavaxEmailMessageTransport.Type.RelativeName + " resumed")
  }
