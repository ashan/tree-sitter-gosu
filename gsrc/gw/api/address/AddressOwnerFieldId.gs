...
class AddressOwnerFieldId {
   ...
   */
  public static final var ATTENTION_ACC: AddressOwnerFieldId = new AddressOwnerFieldId("Attention_ACC")
  public static final var ADDRESS_FINDER_ACC: AddressOwnerFieldId = new AddressOwnerFieldId("AddressFinder_ACC")
  ...
  public final static var NO_FIELDS: Set<AddressOwnerFieldId>
      = new HashSet<AddressOwnerFieldId>() {
  }.freeze()

  public final static var ALL_PCF_FIELDS: Set<AddressOwnerFieldId> = new HashSet<AddressOwnerFieldId>()
      {ATTENTION_ACC, ADDRESS_FINDER_ACC, ADDRESSLINE1, ADDRESSLINE2, ADDRESSLINE3, CITY, COUNTY, STATE, POSTALCODE, COUNTRY,
          ADDRESSLINE1KANJI, ADDRESSLINE2KANJI, CITYKANJI, CEDEX, CEDEXBUREAU, VALIDUNTIL}.freeze()

  public final static var ADDRESSLINE1_FIELDS: Set<AddressOwnerFieldId> = new HashSet<AddressOwnerFieldId>()
      {ATTENTION_ACC, ADDRESS_FINDER_ACC, ADDRESSLINE1, ADDRESSLINE1KANJI}.freeze()
  ...
  public final static var HIDDEN_FOR_SEARCH: Set<AddressOwnerFieldId> = new HashSet<AddressOwnerFieldId>()
      {ATTENTION_ACC, ADDRESS_FINDER_ACC, ADDRESSLINE1, ADDRESSLINE2, ADDRESSLINE3, COUNTY, ADDRESSLINE1KANJI, ADDRESSLINE2KANJI, CEDEX, CEDEXBUREAU, VALIDUNTIL}.freeze()

  public final static var HIDDEN_FOR_PROXIMITY_SEARCH: Set<AddressOwnerFieldId> = new HashSet<AddressOwnerFieldId>()
      {ATTENTION_ACC, ADDRESS_FINDER_ACC, ADDRESSLINE1KANJI, ADDRESSLINE2KANJI, CITYKANJI, CEDEX, CEDEXBUREAU, VALIDUNTIL}.freeze()
}
