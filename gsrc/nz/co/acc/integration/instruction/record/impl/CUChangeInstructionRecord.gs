 ...
 */
class CUChangeInstructionRecord implements InstructionRecord {
  ...
  private var _bicCode : String as readonly BICCode
  ...
  override property get InstructionType() : InstructionType_ACC {
    return InstructionType_ACC.TC_BULKCUCHANGE
  }
