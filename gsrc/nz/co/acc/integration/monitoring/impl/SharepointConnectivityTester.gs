 ...
 */
class SharepointConnectivityTester implements IConnectivityTester {

  override function testConnectivity(): ConnectivityTestResult {
    var helper = new nz.co.acc.common.integration.dms.ui.SharePointConnectivityTestPcfHelper()
