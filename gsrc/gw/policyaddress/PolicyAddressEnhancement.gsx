...
enhancement PolicyAddressEnhancement : entity.PolicyAddress {
  ...
  /**
   * Shared and revisioned address location type.
   */
  property get AddressLocType_ACC() : AddressLocationType_ACC {
    return AddressToPolicyAddressSyncedField.AddressLocType_ACC.getValue(this)
  }

  /**
   * Shared and revisioned address location type.
   */
  property set AddressLocType_ACC(arg : AddressLocationType_ACC) {
    AddressToPolicyAddressSyncedField.AddressLocType_ACC.setValue(this, arg)
  }

  /**
   * Shared and revisioned address policy type.
   */
  property get AddressPolicyType_ACC() : AddressPolicyType_ACC {
    return AddressToPolicyAddressSyncedField.AddressPolicyType_ACC.getValue(this)
  }

  /**
   * Shared and revisioned address policy type.
   */
  property set AddressPolicyType_ACC(arg : AddressPolicyType_ACC) {
    AddressToPolicyAddressSyncedField.AddressPolicyType_ACC.setValue(this, arg)
  }

  /**
   * Shared and revisioned valid Until date
   */
  property get ValidUntil_ACC() : Date {
    return AddressToPolicyAddressSyncedField.ValidUntil_ACC.getValue(this)
  }

  /**
   * Shared and revisioned valid Until date
   */
  property set ValidUntil_ACC(arg : Date) {
    AddressToPolicyAddressSyncedField.ValidUntil_ACC.setValue(this, arg)
  }

  /**
   * Shared and revisioned attention
   */
  property get Attention_ACC() : String {
    return AddressToPolicyAddressSyncedField.Attention_ACC.getValue(this)
  }

  /**
   * Shared and revisioned attention
   */
  property set Attention_ACC(arg : String) {
    AddressToPolicyAddressSyncedField.Attention_ACC.setValue(this, arg)
  }
  ...
  function copyToNewAddress() : Address {
    return new Address() {
      ...
      :AddressLocType_ACC = AddressLocType_ACC,
      :AddressPolicyType_ACC = AddressPolicyType_ACC,
      :ValidUntil = ValidUntil_ACC,
  ...
  function copyFromAddress(address : Address) {
    ...
    AddressLocType_ACC = address.AddressLocType_ACC
    AddressPolicyType_ACC = address.AddressPolicyType_ACC
    ValidUntil_ACC = address.ValidUntil
    Attention_ACC = address.Attention_ACC
  }
}
