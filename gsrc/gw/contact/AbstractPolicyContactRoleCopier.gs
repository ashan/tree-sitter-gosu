...
abstract class AbstractPolicyContactRoleCopier<T extends PolicyContactRole> extends AbstractEffDatedCopyable<T> {
  ...
  override function copyBasicFieldsFromBean(role : T) {
    ...
    var prefix = PersonToPolicyContactRoleSyncedField.Prefix.getPolicyEntityFieldValue(role)
    ...
    PersonToPolicyContactRoleSyncedField.Prefix.setPolicyEntityFieldValue(_bean, prefix)
