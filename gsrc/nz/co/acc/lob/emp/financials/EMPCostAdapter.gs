...
@Export
class EMPCostAdapter implements CostAdapter {

  var _owner: entity.EMPCost
  ...
  override function createTransaction(branch: PolicyPeriod): Transaction {
    var transaction = new EMPTransaction(branch, branch.PeriodStart, branch.PeriodEnd)
    transaction.EMPCost = _owner.Unsliced
    return transaction
  }
