 ...
 */
class RehabRIskMgmtRateRowConverter implements ExcelEntityConverter_ACC<ERRehabRiskMgmtRates_ACC> {
  ...
  override function addEntityToSheet(entity : ERRehabRiskMgmtRates_ACC, workbook : Workbook, sheet : Sheet, rowNumber : Integer) {
