...
enhancement PolicyPeriodBaseEnhancement: PolicyPeriod {
  ...
  function autoSelectUWCompany() {
    ...
    // DE102 - ACC UWCompany always returned so set the Policy Period UWCompany to this.
    this.UWCompany = availableUWCompanies.first()
  }
  ...
  */
   ...
   * Returns all UWIssue's associated with this PolicyPeriod that have not been soft-deleted.
   */
  property get UWIssuesNotApproved() : UWIssue[] {
    return this.UWIssuesIncludingSoftDeleted.where(\ issue -> !issue.Approval.ConditionMet)
  }
