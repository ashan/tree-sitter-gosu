...
class DocumentStoreTransport implements MessageTransport, InitializablePlugin {
  ...
  private var logger = StructuredLogger.MESSAGING.withClass(DocumentStoreTransport)
  ...
  override function resume() : void {
    ...
    logger.info(DocumentStoreTransport.Type.RelativeName + " resumed")
  }


  override function shutdown() : void {
    // since communication is through IDCS & IDMS, there is nothing to do here
    logger.info(DocumentStoreTransport.Type.RelativeName + " shutdown")
  }

  override function suspend() : void {
    // since communication is through IDCS & IDMS, there is nothing to do here
    logger.info(DocumentStoreTransport.Type.RelativeName + " suspended")
  }
