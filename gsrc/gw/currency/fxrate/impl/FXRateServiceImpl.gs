...
class FXRateServiceImpl implements FXRateService {
  ...
  static final var STATIC_TABLE : Map<Pair<Currency, Currency>, BigDecimal> = {
    ...
    // From NZD
    new Pair<Currency, Currency>(TC_NZD, TC_GBP) -> 0.574872282bd,
    new Pair<Currency, Currency>(TC_NZD, TC_RUB) -> 43.2361351bd,
    new Pair<Currency, Currency>(TC_NZD, TC_AUD) -> 0.960313575bd,
    new Pair<Currency, Currency>(TC_NZD, TC_CAD) -> 0.949098441bd,
    new Pair<Currency, Currency>(TC_NZD, TC_JPY) -> 82.4591002bd,
    new Pair<Currency, Currency>(TC_NZD, TC_EUR) -> 0.675827552bd,
    new Pair<Currency, Currency>(TC_NZD, TC_USD) -> 0.725805bd,
    ...
    new Pair<Currency, Currency>(TC_JPY, TC_USD) -> 0.01260483bd,
      ...
      // To NZD
    new Pair<Currency, Currency>(TC_GBP, TC_NZD) -> 1.73951681bd,
    new Pair<Currency, Currency>(TC_RUB, TC_NZD) -> 0.0231288018bd,
    new Pair<Currency, Currency>(TC_AUD, TC_NZD) -> 1.04132653bd,
    new Pair<Currency, Currency>(TC_CAD, TC_NZD) -> 1.05363149bd,
    new Pair<Currency, Currency>(TC_JPY, TC_NZD) -> 0.0121272243bd,
    new Pair<Currency, Currency>(TC_USD, TC_NZD) -> 1.37778053bd
