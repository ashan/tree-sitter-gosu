...
class ApplyStandardModifierCPCPXWorkQueue_ACC extends WorkQueueBase<PolicyTerm, StandardWorkItem> {
  final var LOG = StructuredLogger.CONFIG.withClass(this)

  construct() {
    super(BatchProcessType.TC_APPLYSTANDARDMODIFIERCPCPX_ACC, StandardWorkItem, PolicyTerm)
  }
  ...
  override function findTargets() : Iterator<PolicyTerm> {
      ...
      plQuery.compare(entity.PolicyLine#Subtype, Relop.Equals, PolicyLine.TC_INDCOPLINE)
