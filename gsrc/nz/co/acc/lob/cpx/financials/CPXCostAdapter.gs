...
@Export
class CPXCostAdapter implements CostAdapter {

  var _owner: entity.CPXCost
  ...
  override function createTransaction(branch: PolicyPeriod): Transaction {
    var transaction = new CPXTransaction(branch, branch.PeriodStart, branch.PeriodEnd)
    transaction.CPXCost = _owner.Unsliced
    return transaction
  }
