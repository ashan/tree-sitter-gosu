...
interface AccountRelationship {
  ...
  /**
   * Returns the effective date of relationship.
   *
   * @return the effective date of the relationship.
   */
  property get EffectiveDateFrom_ACC() : Date
  /**
   * Sets the effective date of relationship.
   *
   * @param date the effective date of the relationship to set.
   */
  property set EffectiveDateFrom_ACC(effDate : Date)
}
