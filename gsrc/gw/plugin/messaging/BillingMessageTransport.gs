...
class BillingMessageTransport implements MessageTransport {
  ...
  override function resume() {
    logger.info(BillingMessageTransport.Type.RelativeName + " resumed")
  }

  override property set DestinationID(id: int) { }

  override function shutdown() {
    logger.info(BillingMessageTransport.Type.RelativeName + " shutdown")
  }

  override function suspend() {
    logger.info(BillingMessageTransport.Type.RelativeName + " suspended")
  }
}
