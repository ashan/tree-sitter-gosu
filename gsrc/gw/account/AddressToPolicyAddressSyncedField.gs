...
class AddressToPolicyAddressSyncedField<T> extends AbstractDateAwareAccountSyncedFieldImpl<PolicyAddress, T>{
  ...
  public static final var AddressLocType_ACC   : AddressToPolicyAddressSyncedField<AddressLocationType_ACC> = new AddressToPolicyAddressSyncedField<AddressLocationType_ACC>("AddressLocType_ACC")
  public static final var AddressPolicyType_ACC   : AddressToPolicyAddressSyncedField<AddressPolicyType_ACC> = new AddressToPolicyAddressSyncedField<AddressPolicyType_ACC>("AddressPolicyType_ACC")
  public static final var Attention_ACC    : AddressToPolicyAddressSyncedField<String> = new AddressToPolicyAddressSyncedField<String>("Attention_ACC")
  public static final var ValidUntil_ACC    : AddressToPolicyAddressSyncedField<Date> = new AddressToPolicyAddressSyncedField<Date>("ValidUntil")
