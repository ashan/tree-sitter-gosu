...
class SubmissionProcess extends NewTermProcess {
  ...
  override function start() {
    ...
    if(_branch.Policy.ProductCode.equals("AccreditedEmployersProgramme") == false and
        DateUtil_ACC.isFutureLevyYear(_branch.PeriodEnd) == false) {
      _branch.EffectiveDatedFields.syncModifiers()
      ModifiersUtil_ACC.setSelectedExperienceRating(_branch, ExpRatingProgramme_ACC.TC_STANDARD)
    }
  }
