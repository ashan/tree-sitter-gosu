...
@Export
class SHCCostAdapter implements CostAdapter {

  var _owner: entity.SHCCost
  ...
  override function createTransaction(branch: PolicyPeriod): Transaction {
    var transaction = new SHCTransaction(branch, branch.PeriodStart, branch.PeriodEnd)
    transaction.SHCCost = _owner.Unsliced
    return transaction
  }
