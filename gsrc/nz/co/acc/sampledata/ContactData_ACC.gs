 ...
 */
@Export
class ContactData_ACC extends AbstractSampleDataCollection
{
  construct() { }
  ...
  public override property get AlreadyLoaded() : boolean {
    return companyLoaded("Fonterra Brands")
  }
  ...
  public override function load() {
    Transaction.runWithNewBundle(\bundle -> {
     ...
     // loadPerson(bundle, TC_MR, "Ray", "Newton", TC_WORK, "818-446-1206", null, TC_ACCPHYSICAL, "79 Molesworth Street", "Arcadia", null, "1234", "NZ")
     // loadPerson(bundle, TC_MR, "Stan", "Newton", TC_WORK, "818-446-1206", null, TC_ACCPHYSICAL, "83 Molesworth Street", "Arcadia", null, "1234", "NZ")
      ...
      // COMPANIES
      //loadCompany(bundle, "Fonterra Brands", "093-749-0000", null, false, TC_ACCPHYSICAL, "21 Cashew St, Grenada North", "Wellington", null, "1234", "NZ")
