...
class PolicyContactRoleNameAdapter extends UnsupportedPersonNameFields {
  ...
  override property get MiddleName(): String {
    return _policyContactRole.MiddleNameInternal
  }

  override property set MiddleName(value: String) {
    _policyContactRole.MiddleNameInternal = value
  }

  override property get Prefix(): NamePrefix {
    return _policyContactRole.PrefixInternal
  }

  override property set Prefix(value: NamePrefix) {
    _policyContactRole.PrefixInternal = value
  }
}