...
class TargetAccountRelationship implements AccountRelationship {
  ...
  override property get EffectiveDateFrom_ACC() : Date {
    return _accountAccount.EffectiveDateFrom_ACC
  }

  override property set EffectiveDateFrom_ACC(effDate : Date) {
    _accountAccount.EffectiveDateFrom_ACC = effDate
  }
}
